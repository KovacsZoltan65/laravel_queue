    ...
    <script type="text/javascript">
        const app = {
            ...
            methods: {
                ...
                getUploadProgress() {
                    /**
                     * @description Inicializálja a saját változót a megfelelő kontextus
                     *              megőrzéséhez a beágyazott függvényeken belül.
                     * @type {Object}
                     */
                    let self = this;
                    /**
                     * @description Ellenőrzi, hogy van-e azonosító jelen az URL-ben.
                     *              Ha van, beállítja azt a params objektum azonosítójára.
                     */
